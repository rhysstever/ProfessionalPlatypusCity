...
public class CameraManager : MonoBehaviour
{
    ...
    void Start()
    {
		...
		cameras[0] = gameObject.GetComponent<NPCManager>().player.transform.Find("Camera_ThirdPOV").gameObject.GetComponent<Camera>();
		cameras[1] = gameObject.GetComponent<NPCManager>().player.transform.Find("Camera_FirstPOV").gameObject.GetComponent<Camera>();
